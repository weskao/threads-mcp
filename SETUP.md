...
6. 腳本會自動換取 60 天長期 Token，並更新至 `.env` 中。
   ...
   **瀏覽器授權畫面參考截圖：**
   ![Threads OAuth Consent Screen](images/threads_oauth_consent.png)
...
2. 點擊 **「Generate Access Token」** 取得短期 Token（效期約 1~2 小時）。
   ![Graph API Explorer 設定與 Generate](images/graph_explorer_token.png)
...
>
> ![ERR_NGROK_8012 — 瀏覽器直接打開 ngrok URL 時的預期畫面，非設定錯誤](images/ngrok_err_8012_expected.png)
...
* **偵錯結果示意圖**：
  ![Access Token Debugger 偵錯結果](images/token_debugger_screenshot.png)
* **主要用途**：
